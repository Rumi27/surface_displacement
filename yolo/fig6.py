...
matplotlib.rcParams['axes.labelsize'] = 16       # axis labels (not used here but good for consistency)
...
for ax, case in zip(axs.flat, cases):
    ...
    ax.set_title(f"{case} – Ground truth", fontsize=18)
...
fig.savefig("fig6_ground_truth_grid.png", dpi=600, bbox_inches="tight")
plt.close()
print("✓ Saved: fig6_ground_truth_grid.png")
